;( function( $, window, document, undefined ) {
	...
	"use strict";
		...
		var pluginName = "isiaFormRepeater",
			el,
			addEl,
			removeEl,
			fieldId,
			...
			repeatItem,
			defaults = {
        addButton: '<div class="repeat-add-wrapper"><a class="repeat-add" href="#"><img src="data:image/png;base64," />Add</a></div>',
        removeButton: '<a class="repeat-remove" href="#"><img src="data:image/png;base64," />Remove</a>'
      };
		...
		$.extend( Plugin.prototype, {
			 ...
			 * @type {[type]}
			 */
			this.addEl = $(this.el + ' .repeat-add');

			/**
			 * [removeEl The remove button class]
			 * @type {[type]}
			 */
			this.removeEl = $(this.el + ' .repeat-remove');
			...
			createAddButton: function(){
				$(this.el).append(this.settings.addButton);
			},
			createRemoveButton: function(removeButton){
				$(this.el + ' .repeat-item').each(function(i, e) {
					if(i !== 0){
						$(this).prepend(removeButton);
					}
				});				
			},
			addItem: function(el, addEl, itemsIndexArray, maxItemIndex, removeButton, repeatItem){
				$(el).on('click', addEl, function(event) {
					event.preventDefault();
					if(event.target.className !== 'repeat-add'){
            ...
            repeatItem.find('radio').checked = false
						repeatItem.find('.repeat-el').each(function(index, el) {
							var newName = this.name.replace(/[\[]\d+[\]]/g, '[' + maxItemIndex + ']');
							this.name = newName;
							this.id = this.name;
						});
			...
			removeItem: function(el, removeEl, itemsIndexArray, maxItemIndex){
				$(el + ' .repeat-item').on('click', removeEl, function(event) {
					event.preventDefault();
					if(event.target.className !== 'repeat-remove'){
						event.stopPropagation();
					}else{
						var currentFieldIndex = parseInt($(this).attr('data-field-index'));
						if (currentFieldIndex !== 1){
							var remove_index = itemsIndexArray.indexOf(currentFieldIndex);
